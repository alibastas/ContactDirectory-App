...
{
    Task<ContactRequest> CreateAsync(CreateContactRequestDto dto, int userId, string username, IFormFile? file = null);
    ...
    Task<(Stream FileStream, string ContentType, string FileName)?> GetAttachmentAsync(int requestId, int userId, string userRole);
